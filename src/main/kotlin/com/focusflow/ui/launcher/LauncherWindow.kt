...
private fun LauncherWindowForScreen(bounds: Rectangle, isPrimary: Boolean) {
    ...
    Window(
        ...
        state = windowState,
        undecorated = true,
        // Unlike the imported Windows-only implementation, this is dynamic:
        // breaks must let other desktop windows come forward on Linux too.
        alwaysOnTop = shouldBeTopmost,
        resizable = false,
        focusable = true,
